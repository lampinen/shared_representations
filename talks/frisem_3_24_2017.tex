...
\begin{frame}{Results}
Suppose we share some weights, can we see evidence of preparation for future learning?
\begin{columns}
\column{0.45\textwidth}
    \uncover<2->{
    Second layer output modes:
...
\begin{itemize}
    ...
    \begin{itemize}
	\item<6-> Possible amortized inference about analogies.
	\item<7-> Benefits of multiple mutually supporting tasks.
	\item<8-> Preparation for future learning.
    \end{itemize}
\end{itemize}
\end{frame}

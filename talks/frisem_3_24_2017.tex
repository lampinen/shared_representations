...
\uncover<6->{In this talk we'll focus on the ``slow'' type, which we think could explain much of the transfer that supports human intelligence (e.g. preparation for learning).}
\end{frame}
